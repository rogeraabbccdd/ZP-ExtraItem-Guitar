 ...
 **/
#define EXTRA_ITEM_NAME				"Guitar" 
#define EXTRA_ITEM_COST				5
#define EXTRA_ITEM_LEVEL			0
#define EXTRA_ITEM_ONLINE			0
#define EXTRA_ITEM_LIMIT			0

#define WEAPON_NAME					"weapon_guitar"
#define WEAPON_REFERANCE			"weapon_galilar"

#define MODEL_WORLD 				"models/weapons/w_cso_guitar.mdl"
#define MODEL_VIEW					"models/weapons/v_cso_guitar.mdl"

#define SOUND_FIRE					"weapons/guitar.mp3"
...
public void OnMapStart(/*void*/)
{
	...
	AddFileToDownloadsTable("models/weapons/v_cso_guitar.dx90.vtx");
	AddFileToDownloadsTable("models/weapons/v_cso_guitar.mdl");
	AddFileToDownloadsTable("models/weapons/v_cso_guitar.vvd");
	AddFileToDownloadsTable("models/weapons/w_cso_guitar.dx90.vtx");
	AddFileToDownloadsTable("models/weapons/w_cso_guitar.mdl");
	AddFileToDownloadsTable("models/weapons/w_cso_guitar.vvd");

	// Add textures to download list
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/CSO_HighQ_Hand 512_normal.vtf");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/CSO_HighQ_Hand_512.vmt");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/CSO_HighQ_Hand_512.vtf");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/CSO_HighQ_Hand_512_normal.vtf");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/guitar.vmt");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/guitar.vtf");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/guitar_ref.vtf");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/note1.vmt");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/note1.vtf");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/note2.vmt");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/note2.vtf");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/note3.vmt");
	AddFileToDownloadsTable("materials/models/weapons/v_models/CSOLguita/note3.vtf");
	AddFileToDownloadsTable("materials/models/weapons/w_models/guita/guitar.vmt");
	AddFileToDownloadsTable("materials/models/weapons/w_models/guita/guitar.vtf");
	AddFileToDownloadsTable("materials/models/weapons/w_models/guita/guitar_ref.vtf");
}
